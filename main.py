...
class Database:
    ...
    def insert(self):
        ...
        for record in records:
            ...
            # Incrementing the record number each time one gets added.
            record_num +=1
    ...
    def update(self):
        # All the possible columns that can be updated, the user cannot change the ID since it is generated by the database.
        names = ['EnglishName', 'JapaneseName', 'Birthday', 'Anime']
    ...
    def delete(self):
        # Program prompts user for the character ID of the character they would like to delete.
        user_search = input("Please enter the id of character: ")

        # SQL Command.
        cur.execute(f"DELETE FROM usercharacters.Characters WHERE CharacterID = {user_search}")
